<?php
/* Smarty version 4.3.4, created on 2023-12-20 20:44:52
  from 'F:\WebDev\Xampp\htdocs\secret-santa\views\login.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65834434b59179_56989246',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8540cc51f5c2553269579cf3feeca179db54e65c' => 
    array (
      0 => 'F:\\WebDev\\Xampp\\htdocs\\secret-santa\\views\\login.html',
      1 => 1703101489,
      2 => 'file',
    ),
  ),
...
function content_65834434b59179_56989246 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
                            ...
                            <form action="controllers/register.php" method="POST">
                                ...
                                <div class='form-floating mt-5 d-flex justify-content-center'>
                                    <input type='text' class='form-control bg-transparent shadow border border-0'
                                        id='registerEmail' placeholder='' value=''
                                        pattern='[^\s@]+@[^\s@]+\.[^\s@]+$' />
                                    <label class='fw-bold' for='email fs'>Email</label>
                                </div>
                                <div class='form-floating mb-5 d-flex justify-content-center'>
                                    <input type='password' class='form-control bg-transparent shadow border border-0'
                                        id='registerPassword' placeholder='' value='' pattern='^[A-Za-z0-9]+$' />
                                    <label class='fw-bold' for='password fs'>Password</label>
                                </div>
                                <div class='d-flex justify-content-center'>
